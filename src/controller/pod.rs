...
///
/// Only the `stable` tag is supported; never pin a versioned tag.
pub const DEFAULT_WORKER_IMAGE: &str = "public.ecr.aws/e0h8a4b6/devin-cli:stable";
